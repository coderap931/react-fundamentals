        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects can return cleanup functions, which can clean up timers using memory, listeners to outdie API's, and other functions which may use system resources</li>
                </ul>
                <SampleEffect />
                <br />
                <SampleEffect />
...
const SampleEffect = () => {
    ...
    useEffect(() => {
        console.log('this painting needs some happy tress');
    })
